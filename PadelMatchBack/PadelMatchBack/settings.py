"""
Django settings for PadelMatchBack project.
...
SECRET_KEY = 'django-insecure-=r+q8^@_uqe$=pww&kz=4#yzu)a$1wpo-ukeulz4c-^@(@$zhs'
...
WSGI_APPLICATION = 'PadelMatchBack.wsgi.application'
